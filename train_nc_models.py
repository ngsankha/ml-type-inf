...
setup_model.save_labels(label_to_idx, 'nc_{}_label_to_idx'.format(LABEL_CHOICE))
setup_model.save_labels(idx_to_label, 'nc_{}_idx_to_label'.format(LABEL_CHOICE))
...
model.save('models/nc_{}_model.h5'.format(LABEL_CHOICE))
